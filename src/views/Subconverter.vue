  ...
  data() {
    return {
      ...
      options: {
        ...
        customBackend: {
          "自建后端": "https://subconverter.sakuya.me",
          "备用后端 1": "https://api.v1.mk",
          "备用后端 2": "https://url.v1.mk",
        },
        backendOptions: [
          {value: "https://subconverter.sakuya.me"},
    ...
    getBackendVersion() {
      this.$axios
          ...
          .then(res => {
            ...
            this.$message.success(`${this.backendVersion}` + "后端可用");
          })
          .catch(() => {
